...
class Aes{
	public:
		/*ENCRYPTION METHODS*/
		void keyExpansionCore(unsigned char*, unsigned char);
		...
		std::string encryptUtil(unsigned char *key, std::string);
		void encrypt(unsigned char*, unsigned char*);
		/*DECRYPTION METHODS*/
		void subRoundKey(unsigned char*, unsigned char*);
		void inverseMixColumns(unsigned char*);
		void dShiftRows(unsigned char*);
		void dSubBytes(unsigned char*);
		void round(unsigned char*, unsigned char*);
		void initialRound(unsigned char*, unsigned char*);
		std::string decryptUtil(unsigned char*, std::string);
		void decrypt(unsigned char*, unsigned char*, unsigned char*);
		/*MISC*/
		void timedEncryptNumWords(int); //Records runtime of methods for n words encrypted
		void timedEncryptSizeWords(int);
};
